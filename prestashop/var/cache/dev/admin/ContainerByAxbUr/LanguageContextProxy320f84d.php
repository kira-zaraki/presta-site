...
class LanguageContextProxy320f84d extends \PrestaShop\PrestaShop\Core\Context\LanguageContext implements \Symfony\Component\VarExporter\LazyObjectInterface
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".'*'."\0".'dateFormat' => [parent::class, 'dateFormat', null, 522],
        "\0".'*'."\0".'dateTimeFormat' => [parent::class, 'dateTimeFormat', null, 522],
        "\0".'*'."\0".'id' => [parent::class, 'id', null, 522],
        "\0".'*'."\0".'isRTL' => [parent::class, 'isRTL', null, 522],
        "\0".'*'."\0".'isoCode' => [parent::class, 'isoCode', null, 522],
        "\0".'*'."\0".'languageCode' => [parent::class, 'languageCode', null, 522],
        "\0".'*'."\0".'locale' => [parent::class, 'locale', null, 522],
        "\0".'*'."\0".'localizationLocale' => [parent::class, 'localizationLocale', null, 522],
        "\0".'*'."\0".'name' => [parent::class, 'name', null, 522],
        'dateFormat' => [parent::class, 'dateFormat', null, 522],
        'dateTimeFormat' => [parent::class, 'dateTimeFormat', null, 522],
        'id' => [parent::class, 'id', null, 522],
        'isRTL' => [parent::class, 'isRTL', null, 522],
        'isoCode' => [parent::class, 'isoCode', null, 522],
        'languageCode' => [parent::class, 'languageCode', null, 522],
        'locale' => [parent::class, 'locale', null, 522],
        'localizationLocale' => [parent::class, 'localizationLocale', null, 522],
        'name' => [parent::class, 'name', null, 522],
    ];
