...
class LegacyControllerContextProxyB5bf0c4 extends \PrestaShop\PrestaShop\Core\Context\LegacyControllerContext implements \Symfony\Component\VarExporter\LazyObjectInterface
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".'*'."\0".'adminFolderName' => [parent::class, 'adminFolderName', null, 522],
        "\0".'*'."\0".'container' => [parent::class, 'container', null, 522],
        "\0".'*'."\0".'employeeLanguageId' => [parent::class, 'employeeLanguageId', null, 522],
        "\0".'*'."\0".'isLanguageRTL' => [parent::class, 'isLanguageRTL', null, 522],
        "\0".'*'."\0".'languages' => [parent::class, 'languages', null, 8],
        "\0".'*'."\0".'physicalUri' => [parent::class, 'physicalUri', null, 522],
        "\0".'*'."\0".'psVersion' => [parent::class, 'psVersion', null, 522],
        "\0".'*'."\0".'request' => [parent::class, 'request', null, 522],
        "\0".'*'."\0".'twig' => [parent::class, 'twig', null, 522],
        'adminFolderName' => [parent::class, 'adminFolderName', null, 522],
        'ajax' => [parent::class, 'ajax', null, 4],
        'className' => [parent::class, 'className', null, 8710],
        'confirmations' => [parent::class, 'confirmations', null, 4],
        'container' => [parent::class, 'container', null, 522],
        'controller_name' => [parent::class, 'controller_name', null, 8710],
        'controller_type' => [parent::class, 'controller_type', null, 8710],
        'css_files' => [parent::class, 'css_files', null, 4],
        'currentIndex' => [parent::class, 'currentIndex', null, 8710],
        'employeeLanguageId' => [parent::class, 'employeeLanguageId', null, 522],
        'errors' => [parent::class, 'errors', null, 4],
        'id' => [parent::class, 'id', null, 8710],
        'imageType' => [parent::class, 'imageType', null, 4],
        'informations' => [parent::class, 'informations', null, 4],
        'isLanguageRTL' => [parent::class, 'isLanguageRTL', null, 522],
        'js_files' => [parent::class, 'js_files', null, 4],
        'languages' => [parent::class, 'languages', null, 8],
        'multishop_context' => [parent::class, 'multishop_context', null, 8710],
        'multishop_context_group' => [parent::class, 'multishop_context_group', null, 4],
        'override_folder' => [parent::class, 'override_folder', null, 8710],
        'page_header_toolbar_btn' => [parent::class, 'page_header_toolbar_btn', null, 4],
        'php_self' => [parent::class, 'php_self', null, 8710],
        'physicalUri' => [parent::class, 'physicalUri', null, 522],
        'psVersion' => [parent::class, 'psVersion', null, 522],
        'request' => [parent::class, 'request', null, 522],
        'table' => [parent::class, 'table', null, 8710],
        'token' => [parent::class, 'token', null, 8710],
        'twig' => [parent::class, 'twig', null, 522],
