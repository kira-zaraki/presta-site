...
class EmployeeContextProxy765167e extends \PrestaShop\PrestaShop\Core\Context\EmployeeContext implements \Symfony\Component\VarExporter\LazyObjectInterface
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".'*'."\0".'allShopsIds' => [parent::class, 'allShopsIds', null, 522],
        "\0".'*'."\0".'employee' => [parent::class, 'employee', null, 522],
        'allShopsIds' => [parent::class, 'allShopsIds', null, 522],
        'employee' => [parent::class, 'employee', null, 522],
    ];
